...
式中除了做加減乘除等運算外，還須要求平方根。當然在程式語言裏有內建函數 SQR 可用，但那也是別人事先設計好的程式，求平方根 $\sqrt{d}$ 相當於解方程式 $x^2-d=0$。
...
<p style="text-align:center">圖 4-2</p>
...
<p style="text-align:center">圖 4-3</p>
